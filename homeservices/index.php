...
$cities = ["Nairobi", "Thika","Nakuru","Garissa","Kisumu","Kericho"];

?>

<h2 class="text-center" style="margin-top: 20px">Search</h2>
<hr>
<div class="container" style="margin-top:20px; margin-bottom: 60px;">
    ...
    <div class="row">
        ...
        <div class="form-group col-5">
            ...
            <option value="plumber">Tenure Split</option>
                        <option value="mobile">Social Rented Housing</option>
                        <option value="mobile">Affordable Rented Housing</option>
                        <option value="mobile">Intermediate Tenures Housing</option>
            </select>
        </div>
